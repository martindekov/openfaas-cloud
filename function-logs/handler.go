...
func Handle(req []byte) string {
	...
	formattedLogs, fmtErr := getFormattedLogs(*client, function)
...
func getFormattedLogs(client faasSDK.Client, function string) (string, error) {
	...
	logChan, err := client.GetLogs(context.Background(), logRequest)
	if err != nil {
